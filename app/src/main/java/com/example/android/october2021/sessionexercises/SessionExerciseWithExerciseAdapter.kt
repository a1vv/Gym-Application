...
class SessionExerciseWithExerciseAdapter(private val clickListener: SessionExerciseWithExerciseListener) :
    ListAdapter<SessionExerciseWithExercise, SessionExerciseWithExerciseAdapter.SessionExerciseWithExerciseHolder>(
