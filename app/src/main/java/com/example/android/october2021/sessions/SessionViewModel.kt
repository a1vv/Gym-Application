...
class SessionViewModel(
    ...
    private suspend fun updateSessionWorkouts() {
        // TODO: get workouts connected to session from database
        //sessionWorkoutList.value = database.getWorkoutsOfSession(activeSessionId.value!!)
    ...
    private suspend fun addExerciseToSession() {
        withContext(Dispatchers.IO) {
            ...
            val sessionExercise = SessionExercise(0,"text",activeSessionId.value!!,exerciseId)
